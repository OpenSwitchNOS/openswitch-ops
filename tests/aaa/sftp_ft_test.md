...
### Test case 1.02
Test case enables SFTP server service on dut1 and then host1 copies a file.
### Description
...
### Test case 1.03
Test case performs SFTP put from host1 to dut1 when SFTP server is enabled.
### Description
From host1, perform a SFTP put to dut1.
### Test result criteria
#### Test pass criteria
...
### Test case 1.04
Test case disables SFTP service on dut1 and then host1 copies a file.
### Description
...
### Test case 1.05
Test case performs SFTP put from host1 to dut1 when SFTP server is disabled.
### Description
From host1, perform a SFTP put to dut1.
### Test result criteria
#### Test pass criteria
