...
#             characters it can accept and VLAN name string can be
#             changed correctly.
#
# Author:      Roy Ibarra
#
# Topology:      |Switch|
#
# Success Criteria:  PASS -> Up to 250 alphanumeric characters can be used
#                            to name the VLAN and it can be updated.
#
#                    FAILED -> More than 250 alphanumeric characters
#                              accepted for VLAN name.
#
##########################################################################
