...
def cleanUp(dut, wrkston01Obj, wrkston02Obj):
    LogOutput('info', "############################################")
    LogOutput('info', "Step 15- CleanUp")
    LogOutput('info', "############################################")
    finalResult = []
    # Delete vlan 2
...
class Test_vlan_state_reason_transition:
    ...
    def test_add_vlan(self):
        ...
        if AddVlan(deviceObj=self.dut01Obj, vlanId=3).returnCode() != 0:
            ...
            assert(False)
        elif verifyVlan(self.dut01Obj, "3"):
        ...
        if AddVlan(deviceObj=self.dut01Obj, vlanId=4).returnCode() != 0:
            ...
            assert(False)
        elif verifyVlan(self.dut01Obj, "4"):
    ...
    def test_verify_vlan_stateShutdown(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 3- Verify vlan status before enabling it")
        LogOutput('info', "############################################")
    ...
    def test_verify_vlan_ReasonShutdown(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 4- Verify vlan reason before enabling it")
        LogOutput('info', "############################################")
    ...
    def test_enable_vlan(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 5- Enable one of the configured vlans")
        LogOutput('info', "############################################")
    ...
    def test_verify_vlan_stateNoShutdown(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 6- Verify vlan status")
        LogOutput('info', "############################################")
        if verifyVlanState(dut=self.dut01Obj, status="down",
                           numberToFind="2") != 0:
            LogOutput('error', "Failed to verify vlan " + str(2) + "status")
    ...
    def test_addPort_vlan(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 8- Add port to vlan")
        LogOutput('info', "############################################")
    ...
    def test_verify_vlan_stateUp(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 9- Verify vlan status")
        LogOutput('info', "############################################")
    ...
    def test_Disable_vlan(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 11- Disable vlan")
        LogOutput('info', "############################################")
        if VlanStatus(deviceObj=self.dut01Obj, vlanId=2,
    ...
    def test_verify_vlan_stateDown2(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 12- Verify vlan status down")
        LogOutput('info', "############################################")
        if verifyVlanState(dut=self.dut01Obj, status="down",
                           numberToFind="2") != 0:
            LogOutput('error', "Failed to verify vlan " + str(2) + "status")
    ...
    def test_verify_vlan_ReasonDown(self):
        LogOutput('info', "############################################")
        LogOutput('info', "Step 13- Verify vlan reason")
        LogOutput('info', "############################################")
        if verifyVlanReason(dut=self.dut01Obj,
                            pReason="admin_down", numberToFind="2") != 0:
            LogOutput('error', "Failed to verify vlan " + str(2) + " reason")
