...
def restTestFans(wrkston01):
    ...
    info('### Success in Rest GET for Fan base-3L ###\n')
    ...
    info('### Success in Rest GET for Fan base-4L ###\n')
    ...
    info('### Success in Rest GET for Fan base-1R ###\n')
    ...
    info('### Success in Rest GET for Fan base-2R ###\n')
    ...
    info('### Success in Rest GET for Fan base-5R ###\n')
    retStruct = returnStruct(returnCode=0)
    return retStruct
