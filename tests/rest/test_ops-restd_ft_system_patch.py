...
class PatchSystemTest(OpsVsiTest):
    ...
    def test_patch_add_an_empty_optional_parameter(self):
        # Test Setup
        test_title = "using \"op\": \"add\" empty optional parameter"
        info(TEST_START % test_title)
        # 1 - Query Resource
        response, response_data = execute_request(
            self.path, "GET", None, self.switch_ip, True,
...
class Test_PatchSystem:
    ...
    def test_call_patch_add_an_empty_optional_parameter(self, netop_login):
        self.test_var.test_patch_add_an_empty_optional_parameter()
