...
invalid_post_data = {"configuration": {"name": "bridge_normal3"}}
...
class Test_ft_framework_rest:
    ...
    def test_restTestCustomValidators(self):
        ...
        info('########################################################\n')
        wrkston01Obj = self.topoObj.deviceObjGet(device="wrkston01")
        retStruct = restTestCustomValidators(wrkston01Obj)
        assert retStruct.returnCode() == 0, 'Failed to test REST validators'
