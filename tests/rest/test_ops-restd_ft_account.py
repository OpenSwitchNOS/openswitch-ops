...
class AccountTest(OpsVsiTest):
    ...
    def query_account_information_logged_in(self):
        ...
        # TODO Do something about hard coded values
        assert role == 'ops_netop', \
...
class Test_Account:
    ...
    def test_change_password_bad_current_password(self):
    ...
    def test_change_password_successful_change(self):
        self.test_var.change_password_successful_change()

    def test_query_account_information_logged_in(self):
