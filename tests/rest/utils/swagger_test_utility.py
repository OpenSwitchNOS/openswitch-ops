#######################------Description------################################
# This is a utility which is intended to catch any bugs in swagger. Since    \
# swagger uses ops-restapi.json generated using the vswitch.extschema and    \
# vswitch.xml by apidocgen.py, this utility is more likely to catch bugs in  \
# this part of the code.                                                     \
# We are planning to use this code as a plugin, so we simply have to call    \
# swagger_model_verification(...) function from the individual feature tests.\
# The swagger bugs (apidocgen.py bugs), if any, will then be listed in the   \
# feature test output
##############################################################################
