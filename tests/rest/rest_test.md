...
- Verify if VLAN was updated sucessfully using If-Match header using value `*` as Etag:
 ...
 4. Execute PUT request over "/rest/v1/system/bridges/bridge_normal/vlans/test?selector=configuration" and include the If-Match Header using field value `*` as Etag
...
- Verify if VLAN was updated unsucessfully using If-Match header with a matching Etag
 1. Execute a GET request over "/rest/v1/system/bridges/bridge_normal/vlans/test?selector=configuration"
...
- An HTTP response is not equal to `412 Precondition Failed`
...
- Verify if VLAN was added sucessfully using If-Match header with a matching Etag
...
- Verify if the VLANs are retrieved sucessfully using If-Match header with a matching Etag
 1. Execute a GET request over "/rest/v1/system/bridges/bridge_normal/vlans?selector=configuration"
 2. Read Etag header field provided by the server
...
- Verify if the VLANs aren't retrieved using If-Match header with a not matching Etag
 ...
 2. Read Etag header field provided by the server
 3. Change the Etag value read at step 2
 4. Execute GET request over "/rest/v1/system/bridges/bridge_normal/vlans?selector=configuration" and include the If-Match Header using the Etag read at step 4.
 6. Verify if the HTTP response is `412 Precondition Failed`
...
- Verify if the VLAN is retrieved sucessfully using If-Match header with a matching Etag
 1. Execute a GET request over "/rest/v1/system/bridges/bridge_normal/vlans/test?selector=configuration"
 2. Read Etag header field provided by the server
...
- Verify if the VLAN is not retrieved using If-Match header with a not matching Etag
 ...
 2. Read Etag header field provided by the server
 3. Change the Etag value read at step 2
 4. Execute GET request over "/rest/v1/system/bridges/bridge_normal/vlans/test?selector=configuration" and include the If-Match Header using the Etag read at step 4.
 6. Verify if the HTTP response is `412 Precondition Failed`
...
### Description
- Verify if the VLAN is deleted sucessfully using If-Match header with a matching Etag
 2. Execute a GET request over "/rest/v1/system/bridges/bridge_normal/vlans/VLAN2?selector=configuration"
 2. Read Etag header field provided by the server
...
- An HTTP response is not equal to `204 No Content`
- HTTP response is not empty
...
- Verify if the VLAN is not deleted using If-Match header with a not matching Etag
 ...
 2. Read Etag header field provided by the server
 3. Change the Etag value read at step 2
 4. Execute DELETE request over "/rest/v1/system/bridges/bridge_normal/vlans/test?selector=configuration" and include the If-Match Header using the Etag read at step 4.
 6. Verify if the HTTP response is `412 Precondition Failed`
