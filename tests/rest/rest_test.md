...
1. Verify if the request passes when trying to delete a new user who is part of ovsdb_users group and is not logged in.
 - a. Execute the DELETE request over /rest/v1/system/users/{id}.
 - b. Verify if the HTTP response is 204 NO CONTENT.
 - c. Confirm that the returned user list has the expected data.

2. Verify if the request fails when trying to delete a new user who is part of ovsdb_users group and is logged in.
 - a. Execute the DELETE request over /rest/v1/system/users/{id}.
