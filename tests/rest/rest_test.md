...
- The fifth GET test passes, if the response for the REST call with 0000-00-00 00:00:00 timestamp returns HTTP method `400 BAD_REQUEST`.
...
- The fifth GET test fails, if the response for the REST call does not return HTTP method `400 BAD_REQUEST`.
