...
class Test_ft_LAG_static_L4_TCP_UDP_Hashing_Flow_Distribution:
    ...
    def test_send_validated_traffic(self):
        ...
        LogOutput('info', "LAG interface %d stats : " % interfaceLag1 + str(tx1Delta))
        LogOutput('info', "LAG interface %d stats : " % interfaceLag2 + str(tx2Delta))
        ...
        LogOutput('info', "LAG interface %d stats : " % interfaceLag1 + str(tx1Firts))
        LogOutput('info', "LAG interface %d stats : " % interfaceLag2 + str(tx2Firts))
