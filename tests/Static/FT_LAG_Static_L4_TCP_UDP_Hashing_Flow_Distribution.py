...
class Test_ft_LAG_static_L4_TCP_UDP_Hashing_Flow_Distribution:
    ...
    def test_send_validated_traffic(self):
        ...
        LogOutput('info', "First LAG interface stats : " + str(tx1Delta))
        LogOutput('info', "Second LAG interface stats : " + str(tx2Delta))
        ...
        LogOutput('info', "First LAG interface stats : " + str(tx1Firts))
        LogOutput('info', "Second LAG interface stats : " + str(tx2Firts))
