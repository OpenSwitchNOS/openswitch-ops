...
class Test_ft_LAG_Static_L2_Hashing_Flow_Distribution:
    ...
    def test_send_validated_traffic(self):
        ...
        raw2Tx = int(tx2Second) - int(tx2Delta)
        raw1Tx = int(tx1Second) - int(tx1Delta)

        differencieTx = abs(raw2Tx - raw1Tx)
        ...
        if lowBandError > differencieTx or  differencia > highBandError:
