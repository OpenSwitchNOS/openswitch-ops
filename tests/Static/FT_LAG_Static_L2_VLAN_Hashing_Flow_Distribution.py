...
class Test_ft_LAG_static_L2_VLAN_Hashing_Flow_Distribution:
    ...
    def test_interface_vlan(self):
        ...
        for currentInterface in listDut02Interface:
            ...
            if devIntLagRetStruct.returnCode() != 0:
                ...
                LogOutput('info', "Passed vlan configured in the interface")
        ...
        if devIntLagRetStruct.returnCode() != 0:
            LogOutput('error',
                      "Failed to configured intrface vlan 600")
            assert(False)
        else:
    ...
    def test_configured_switch_ip_address(self):
        ...
        if retStruct.returnCode() != 0:
            LogOutput('error', "Failed to configured  IP on interface vlan 500")
            assert(False)
        else:
            LogOutput('info', "Successfully configured IP on interface vlan 500")
        ...
        if retStruct.returnCode() != 0:
            LogOutput('error', "Failed to configured  IP on interface vlan 600")
            assert(False)
        else:
            LogOutput('info', "Successfully configured IP on interface vlan 600")
