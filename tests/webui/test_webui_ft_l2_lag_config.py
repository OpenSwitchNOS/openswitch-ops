...
class Test_CreateLag(OpsVsiTest):
    ...
    def delete_lag(self, switch, cookie_header, lagId, interfaces):
        ...
        self.remove_lacp_aggregation_key_ints(switch, cookie_header,
                                              interfaces)
    ...
    def remove_lacp_aggregation_key_ints(self, switch, cookie_header,
                                         interfaces):
        for interface in interfaces:
            self.remove_lacp_aggregation_key_int(switch, cookie_header,
                                                 interface)

    def remove_lacp_aggregation_key_int(self, switch, cookie_header,
                                        interface):
        int_path = self.PATH_INT + "/" + interface
