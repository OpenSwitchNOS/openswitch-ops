...
class Test_OverviewData(OpsVsiTest):
    ...
    def test_overview_data(self):
        ...
        assert 'Product Name' in other_info
        assert 'part_number' in other_info
        assert 'onie_version' in other_info
        assert 'base_mac_address' in other_info
        assert 'serial_number' in other_info
        assert 'vendor' in other_info
        assert 'max_interface_speed' in other_info
        assert 'max_transmission_unit' in other_info
        assert 'interface_count' in other_info
        ...
        assert 'hostname' in system_config
        assert 'switch_version' in system_status
