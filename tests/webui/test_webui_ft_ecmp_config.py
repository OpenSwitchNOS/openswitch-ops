...
class Test_EcmpConfig(OpsVsiTest):
    ...
    def test_ecmp_enable(self):
        ...
        # enable ecmp
        ECMP_PATCH[0]["value"]["enabled"] = ECMP_PATCH[0]["value"].\
            pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["enabled"] = t
        ...
        assert status_code == httplib.OK, "Failed to query ecmp config"
        json_data = get_json(response_data)
        assert json_data["configuration"]["ecmp_config"]["enabled"] == t,\
            "ECMP enable failed"
    ...
    def test_ecmp_disable(self):
        ...
        assert status_code == httplib.OK, "Failed to query ecmp config"
        json_data = get_json(response_data)
        assert json_data["configuration"]["ecmp_config"]["enabled"] == f,\
            "ECMP disable failed"
    ...
    def test_ecmp_dstip_enable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_dstip_enabled"] = ECMP_PATCH[0]["value"].\
            pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_dstip_enabled"] = t
    ...
    def test_ecmp_dstip_disable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_dstip_enabled"] = ECMP_PATCH[0]["value"].\
            pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_dstip_enabled"] = f
    ...
    def test_ecmp_srcip_enable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_srcip_enabled"] = ECMP_PATCH[0]["value"].\
            pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_srcip_enabled"] = t
        ...
        assert json_data["configuration"]["ecmp_config"]["hash_srcip_enabled"]\
            == t, "ECMP source IP enable failed"
    ...
    def test_ecmp_srcip_disable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_srcip_enabled"] = ECMP_PATCH[0]["value"].\
            pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_srcip_enabled"] = f
        ...
        json_data = get_json(response_data)
        assert json_data["configuration"]["ecmp_config"]["hash_srcip_enabled"]\
            == f, "ECMP source IP disable failed"
    ...
    def test_ecmp_dstport_enable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_dstport_enabled"] = t
        ...
        assert \
            ...
            == t, "ECMP dest port enable failed"
    ...
    def test_ecmp_dstport_disable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_dstport_enabled"] = \
            ECMP_PATCH[0]["value"].pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_dstport_enabled"] = f
        ...
        assert \
            json_data["configuration"]["ecmp_config"]["hash_dstport_enabled"] \
            == f, "ECMP dest port disable failed"
    ...
    def test_ecmp_srcport_enable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_srcport_enabled"] = \
            ECMP_PATCH[0]["value"].pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_srcport_enabled"] = t
        ...
        assert \
            ...
            == t, "ECMP source port enable failed"
    ...
    def test_ecmp_srcport_disable(self):
        ...
        ECMP_PATCH[0]["value"]["hash_srcport_enabled"] = \
            ECMP_PATCH[0]["value"].pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["hash_srcport_enabled"] = f
        ...
        assert \
            json_data["configuration"]["ecmp_config"]["hash_srcport_enabled"] \
            == f, "ECMP source port disable failed"
    ...
    def test_ecmp_reshash_enable(self):
        ...
        ECMP_PATCH[0]["value"]["resilient_hash_enabled"] = \
            ECMP_PATCH[0]["value"].pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["resilient_hash_enabled"] = t
        ...
        assert json_data[
            ...
            == t, "ECMP resilient hash enable failed"
    ...
    def test_ecmp_reshash_disable(self):
        ...
        ECMP_PATCH[0]["value"]["resilient_hash_enabled"] = \
            ECMP_PATCH[0]["value"].pop(ECMP_PATCH[0]["value"].keys()[0])
        ECMP_PATCH[0]["value"]["resilient_hash_enabled"] = f
        ...
        assert json_data[
            "configuration"]["ecmp_config"]["resilient_hash_enabled"]\
            == f, "ECMP resilient hash disable failed"
