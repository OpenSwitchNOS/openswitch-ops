...
```
### Description
This test is used to ensure that the sFlow feature works on OpenSwitch.
...
```
14. Change the max datagram size to 1000 bytes and ping from the host to the switch. The sflowtool is able to see sFlow datagrams of 1000 bytes.
```
