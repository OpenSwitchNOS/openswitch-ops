...
8. Associate interfaces 1 to LAG 20 in Switch 2
...
24. Associate interface 3 in switch 2 to vlan 200
...
"show lacp interface"
32. Get state from interfaces 1, 2 and 3 in switch 3 with CLI command
"show lacp interface"
33. Change interface 4 in switch 3 to Vlan 100
...
#### Test Pass Criteria
* LAGs are configured correctly on both switches
* Validate ping in step 23
* Validate ping in step 28
* Validations in after step 31
...
* Validate ping in step 34
* Validate ping in step 37
