...
#
###############################################################################
# Name:        test_lag_lacp_ft_link_state.py
#
...
#                                   (Dynamic LAG - 2 links)
#
# Success Criteria:  PASS -> Status are  correct transmitted by the lag
#
#                    FAILED -> Status are not pass by the lag
#
###############################################################################
import pytest
import re
...
class test_lag_lacp_ft_link_state:
    ...
    def setup_class(cls):
        ...
        test_lag_lacp_ft_link_state.testObj = testEnviron(
            topoDict=topoDict)
        test_lag_lacp_ft_link_state.topoObj = \
            test_lag_lacp_ft_link_state.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        test_lag_lacp_ft_link_state.topoObj.terminate_nodes()
