...
#
###############################################################################
# Name:        lagDynamicModifyNumberMembers
#
# Description: To verify it is possible to modify dynamic LAG's lower limits
#
...
class Test_lagDynamicModifyNumberMembers:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_lagDynamicModifyNumberMembers.testObj = testEnviron(topoDict=topoDict)
        Test_lagDynamicModifyNumberMembers.topoObj =\
            Test_lagDynamicModifyNumberMembers.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_lagDynamicModifyNumberMembers.topoObj.terminate_nodes()
