...
##########################################################################
# Name:        Test_lag_static_ft_non_consecutive_interfaces
#
# Objective:   To verify a static LAG can be created with non-consecutive interfaces
#
...
class Test_lag_static_ft_non_consecutive_interfaces:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_lag_static_ft_non_consecutive_interfaces.testObj = testEnviron(
            topoDict=topoDict)
        Test_lag_static_ft_non_consecutive_interfaces.topoObj =\
            Test_lag_static_ft_non_consecutive_interfaces.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_lag_static_ft_non_consecutive_interfaces.topoObj.terminate_nodes()
