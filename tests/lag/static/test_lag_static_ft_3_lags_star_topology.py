...
##########################################################################
# Name:        test_lag_static_3_lags_star_topology
#
...
class Test_ft_framework_basics:
    ...
    def test_enableDUTsInterfaces(self):
        ...
        dutList = [[dut01Obj, ["lnk01", "lnk02", "lnk03",
                               "lnk05", "lnk06", "lnk08", "lnk09"]],
        ...
        for dutElement in dutList:
            ...
            for lnk in lnkList:
                ...
                assert(switchEnableInterface(dutObj,
    ...
    def test_createLAGs(self):
        ...
        for lagElement in lagList:
            ...
            for lnk in lnkList:
                LogOutput('info', "Create LAG " + lagId + " on device " +
                          dutObj.device + " for link " + lnk +
                           " with dynamic status " + dynamic)
                assert(
                    lagCreate(dutObj, lagId, True, 
                              [dutObj.linkPortMapping[lnk]], dynamic))
