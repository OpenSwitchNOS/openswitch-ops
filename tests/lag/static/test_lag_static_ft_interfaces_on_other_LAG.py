...
##########################################################################
# Name:        Test_lag_static_ft_interfaces_on_other_LAG
#
...
class Test_lag_static_ft_interfaces_on_other_LAG:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_lag_static_ft_interfaces_on_other_LAG.testObj = testEnviron(
            topoDict=topoDict)
        Test_lag_static_ft_interfaces_on_other_LAG.topoObj =\
            Test_lag_static_ft_interfaces_on_other_LAG.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_lag_static_ft_interfaces_on_other_LAG.topoObj.terminate_nodes()
