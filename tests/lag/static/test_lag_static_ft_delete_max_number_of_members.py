...
#
###############################################################################
# Name:        test_lag_static_ft_delete_max_number_of_members.py
#
...
class Test_ft_delete_max_number_of_members:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_ft_delete_max_number_of_members.testObj =\
        testEnviron(topoDict=topoDict)
        Test_ft_delete_max_number_of_members.topoObj =\
            Test_ft_delete_max_number_of_members.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_ft_delete_max_number_of_members.topoObj.terminate_nodes()
    ...
    def test_deleteLAGs(self):
        ...
        dut01Obj = self.topoObj.deviceObjGet(device="dut01")
        dut02Obj = self.topoObj.deviceObjGet(device="dut02")
        assert(lagCreate(dut01Obj, '1', False, [], None))
        assert(lagCreate(dut02Obj, '1', False, [], None))
    ...
    def test_LAGFormation2(self):
        ...
        lagLinks = ['lnk02', 'lnk03', 'lnk04', 'lnk05', 'lnk06', 'lnk07',
                     'lnk08', 'lnk09']
        assert(not lagVerifyLACPStatusAndFlags(dut01Obj, dut02Obj, False,
                                               lagLinks, 'lag1', 'lag1'))
        assert(not lagVerifyLACPStatusAndFlags(dut02Obj, dut01Obj, False,
                                               lagLinks, 'lag1', 'lag1'))
        assert(workstationsPing(wrkston01Obj, wrkston02Obj, '140.1.1.11', False))
