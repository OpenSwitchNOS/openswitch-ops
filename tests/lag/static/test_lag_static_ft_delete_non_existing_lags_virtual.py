...
#
###############################################################################
# Name:        test_lag_static_ft_delete_non_existing_lags.py
#
...
class Test_ft_delete_non_existing_lags:
    ...
    def test_deleteLAGs1(self):
        ...
        for dut in [dut01Obj, dut02Obj]:
            ...
            assert(lagDeleteNegative(dut, 'XX', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 0')
            assert(lagDeleteNegative(dut, '0', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID -1')
            assert(lagDeleteNegative(dut, '-1', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 2000')
            assert(lagDeleteNegative(dut, '2000', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 2001')
            assert(lagDeleteNegative(dut, '2001', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID @%&$#()')
            assert(lagDeleteNegative(dut, '@%&$#()', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 60000')
            assert(lagDeleteNegative(dut, '60000', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 600')
            assert(lagDeleteNegative(dut, '600', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 2')
            assert(lagDeleteNegative(dut, '2', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
            LogOutput('info', 'With ID 01')
            assert(lagDeleteNegative(dut, '01', '1', 'off', [
                dut.linkPortMapping['lnk02'],
                dut.linkPortMapping['lnk03']], 'l3-src-dst', False,
                False))
