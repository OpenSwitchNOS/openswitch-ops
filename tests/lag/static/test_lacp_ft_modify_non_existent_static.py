...
#
###############################################################################
# Name:        test_lacp_ft_modify_non_existent_static.py
#
# Description: Tests that a non-existent static Link Aggregation does not
...
# Creates a static LAG and assign three interfaces to it on the same
...
# Step 4: Create static LAG and assign it to switch interfaces
