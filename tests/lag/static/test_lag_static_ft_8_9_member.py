...
class Test_lag_static_ft_8_9_member:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_lag_static_ft_8_9_member.testObj = testEnviron(topoDict=topoDict)
        Test_lag_static_ft_8_9_member.topoObj =\
            Test_lag_static_ft_8_9_member.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_lag_static_ft_8_9_member.topoObj.terminate_nodes()
