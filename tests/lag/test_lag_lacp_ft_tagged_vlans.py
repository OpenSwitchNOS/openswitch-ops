...
#
###############################################################################
# Name:        test_lag_lacp_ft_tagged_vlans.py
#
# Description: Tests that different tagged traffic are allowed in a lacp
#
...
class Test_ft_LAG_Dynamic_tagged_vlans:
    ...
    def test_send_traffic(self):
        ...
        LogOutput('info', "\n###############################################")
        LogOutput('info', "# Step 9 - Send traffic between clients")
        LogOutput('info', "###############################################")
