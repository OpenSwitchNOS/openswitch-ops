...
##########################################################################
# Name:        Test_lag_lacp_ft_supported_and_unsupported_names
#
...
class Test_lag_lacp_ft_supported_and_unsupported_names:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_lag_lacp_ft_supported_and_unsupported_names.testObj = testEnviron(
            topoDict=topoDict)
        Test_lag_lacp_ft_supported_and_unsupported_names.topoObj =\
            Test_lag_lacp_ft_supported_and_unsupported_names.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_lag_lacp_ft_supported_and_unsupported_names.topoObj.terminate_nodes()
