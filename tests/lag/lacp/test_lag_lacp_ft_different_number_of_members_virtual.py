...
#
##########################################################################
# Description: To verify a dynamic LAG can be formed between 2 devices
...
class Test_lag_lacp_ft_different_number_of_members:

    def setup_class(cls):
        # Create Topology object and connect to devices
        Test_ft_lacp_different_number_of_members.testObj = testEnviron(
            topoDict=topoDict)
        Test_ft_lacp_different_number_of_members.topoObj =\
            Test_ft_lacp_different_number_of_members.testObj.topoObjGet()
    ...
    def teardown_class(cls):
        ...
        # Terminate all nodes
        Test_ft_lacp_different_number_of_members.topoObj.terminate_nodes()
