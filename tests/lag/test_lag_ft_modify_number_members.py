...
#                Adapted from DynamicLagModifyLowNumberOfMembers
#                by Jose Hernandez
#
...
#                            and pass traffic
#
#                    FAILED -> LAGs cannot be modified to 0, 1, 2 or 3 members
#                    or traffic cannot pass after any of these modifications
#
###############################################################################
...
class Test_lagStaticModifyNumberMembers:
    ...
    def setup_class(cls):
        ...
        Test_lagStaticModifyNumberMembers.testObj = \
    ...
    def test_createLAGs(self):
        LogOutput('info', "\n############################################")
        LogOutput('info', "Create LAG 1 on both switches and assign \
        3 interfaces to it")
        LogOutput('info', "############################################")
