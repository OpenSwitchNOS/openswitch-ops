...
class Test_ft_framework_basics:
    ...
    def test_modifyLAGs3(self):
        ...
        assert(
            addInterfaceToLAG(
                ...
                False, [dut01Obj.linkPortMapping['lnk03']]))
        assert(
            addInterfaceToLAG(
        ...
        assert(
            addInterfaceToLAG(
                ...
                False, [dut02Obj.linkPortMapping['lnk03']]))
        assert(
            addInterfaceToLAG(
    ...
    def test_modifyLAGs4(self):
        ...
        assert(
            addInterfaceToLAG(
                dut01Obj, '1', dut01Obj.linkPortMapping['lnk01'],
                True, [dut01Obj.linkPortMapping['lnk01']]))
        assert(
            addInterfaceToLAG(
                dut01Obj, '1', dut01Obj.linkPortMapping['lnk02'],
                True, [
        ...
        assert(
            addInterfaceToLAG(
                dut02Obj, '1', dut02Obj.linkPortMapping['lnk01'],
                True, [dut02Obj.linkPortMapping['lnk01']]))
        assert(
            addInterfaceToLAG(
                dut02Obj, '1', dut02Obj.linkPortMapping['lnk02'],
                True, [
    ...
    def test_modifyLAGs5(self):
        ...
        assert(
            addInterfaceToLAG(
                dut01Obj, '1', dut01Obj.linkPortMapping['lnk03'],
                False, [dut01Obj.linkPortMapping['lnk01']]))
        LogOutput('info', "Delete LAG members from dut02")
        assert(
            addInterfaceToLAG(
                dut02Obj, '1', dut02Obj.linkPortMapping['lnk02'],
        ...
        assert(
            addInterfaceToLAG(
                dut02Obj, '1', dut02Obj.linkPortMapping['lnk03'],
                False, [dut02Obj.linkPortMapping['lnk01']]))
