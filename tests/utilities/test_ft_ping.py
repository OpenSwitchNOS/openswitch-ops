...
#
# H1 [interface 1]<--->[interface 1] S1
# S1 [interface 2]<--->[interface 2] S2
#
...
class Test_ping:
    ...
    def test_ping_full(self):
        ...
        ping_with_options(host1=wrkston01Obj, switch1=dut01Obj,
                          switch2=dut02Obj)

        LogOutput('info', "\n### Ping with extended options tests ###")
        ping_extended_options(host1=wrkston01Obj, switch1=dut01Obj,
                              switch2=dut02Obj)
        ...
        ping6_with_options(host1=wrkston01Obj, switch1=dut01Obj,
                           switch2=dut02Obj)

        LogOutput('info', "\n### Ping failure test cases ###")
        ping_failure_cases(switch2=dut02Obj)

        LogOutput('info', "\n### Ping6 failure test cases ###")
        ping6_failure_cases(switch2=dut02Obj)
