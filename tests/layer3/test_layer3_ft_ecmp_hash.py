...
class Test_ft_ecmp_hash:
    ...
    def test_disable_all_hash(self):
        ...
        if intf1 != intf2:
            LogOutput('error', "Disable all hashing did not work")
            error(False)
        else:
    ...
    def test_l4src_hash(self):
        ...
        if intf1 == intf2:
            LogOutput('error', "src port hashing I did not work")
            error(False)
        else:
            LogOutput('info', "src port hashing I success")
        ...
        if intf1 != intf2:
            LogOutput('error', "src port hashing II did not work")
            error(False)
        else:
            LogOutput('info', "src port hashing II success")
    ...
    def test_l4dst_hash(self):
        ...
        if intf1 == intf2:
            LogOutput('error', "dst port hashing I did not work")
            error(False)
        else:
            LogOutput('info', "dst port hashing I success")
        ...
        if intf1 != intf2:
            LogOutput('error', "dst port hashing II did not work")
            error(False)
        else:
            LogOutput('info', "dst port hashing II success")
    ...
    def test_l3dst_hash(self):
        ...
        if intf1 == intf2:
            LogOutput('error', "dst IP hashing I did not work")
            error(False)
        else:
            LogOutput('info', "dst IP hashing I success")
        ...
        if intf1 != intf2:
            LogOutput('error', "dst IP hashing II did not work")
            error(False)
        else:
            LogOutput('info', "dst IP hashing II success")
    ...
    def test_l3src_hash(self):
        ...
        if intf1 == intf2:
            LogOutput('error', "src IP hashing I did not work")
            error(False)
        else:
            LogOutput('info', "src IP hashing I success")
        ...
        if intf1 != intf2:
            LogOutput('error', "src IP hashing II did not work")
            error(False)
        else:
            LogOutput('info', "src IP hashing II success")
