    ...
    def run(self):
        ...
        while not exit_flag:
            ...
            if m != -1 and (self.thread_id not in nexthop_list):
                print(">>>{}: MATCH<<<".format(self.thread_id))
                ...
                print(">>>{}: {}<<<".format(self.thread_id, nexthop_list))
...
def test_ecmp(topology):
    ...
    print("Shut down a non-selected port")
    sw1('ip netns exec swns ip route list', shell="bash")
    ...
    print("Re-Enable a non-selected port")
    sw1('ip netns exec swns ip route list', shell="bash")
    ...
    print("Shut down the selected port")
    sw1('ip netns exec swns ip route list', shell="bash")
    ...
    print("Re-enable the selected port")
    sw1('ip netns exec swns ip route list', shell="bash")
