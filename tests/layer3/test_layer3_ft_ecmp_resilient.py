...
def test_ecmp(topology):
    ...
    sw1(
          'set interface {ps1hs1} user_config:admin=up'.format(**locals()),
          shell='vsctl'
    )
    sw1(
          'set interface {ps1nh1} user_config:admin=up'.format(**locals()),
          shell='vsctl'
    )
    sw1(
          'set interface {ps1nh2} user_config:admin=up'.format(**locals()),
          shell='vsctl'
    )
    sw1(
          'set interface {ps1nh3} user_config:admin=up'.format(**locals()),
          shell='vsctl'
    )
    show_int1 = ''
    show_int2 = ''
