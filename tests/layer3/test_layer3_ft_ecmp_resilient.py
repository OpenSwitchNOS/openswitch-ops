...
class GeneratorThread (threading.Thread):
    ...
    def run(self):
        ...
        global exit_flag
        while exit_flag is True and not nexthop_list:
            generated_traffic = self.host('ping -c 1500 -i 1 '
                                          '{0}'.format(self.dst))
...
class ReceiverThread (threading.Thread):
    ...
    def run(self):
        ...
        global nexthop_list
        global check_ping
        global receiver_exit_flag

        while receiver_exit_flag is False:
