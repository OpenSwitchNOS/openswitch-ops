...
class GeneratorThread (threading.Thread):
    ...
    def run(self):
        ...
        while exit_flag is False and not nexthop_list:
            generated_traffic = self.host('ping6 -c 50 -i 0.5 '
                                          '{0}'.format(self.dst))
