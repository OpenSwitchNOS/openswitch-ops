...
4. Verify the **neighbor remove-private-AS** configuration is applied succesfully by checking the routes from switch 2 is received on switch 1 excludes the AS number 65000 for network 13.0.0.0 via the **show ip bgp** command.
