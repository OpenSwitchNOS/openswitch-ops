...
<!--Provide the name of the grouping of commands, for example, LLDP commands-->
 ...
 - Test cases to verify log-rotate configuration
 - Test cases to verify log-rotation and remote transfer

##  Test cases to verify log-rotate configuration ##

### Objective ###
 Test cases to configure various log-rotate parameters and to verify the expected behavior for valid and error scenarios.
...
<pre>
              ...
              +------------------+     |         |         +-------------------+
                                 ...
                                 +---------------------+</pre>
#### Test Setup ####
### Test case 1.01 : To verify default configuration of log-rotate  ###
#### Description ####
With no logrotate configuration in DB, display log-rotate configuration with ‘show’ command.
...
#### Test Fail Criteria ####
If default values are not displayed or if the values are different, then test case fails.

### Test case 1.02 - To verify OVSDB is updated properly for period configuration ###
#### Description ####
Configure logrotate period and check DB is updated properly
...
### Test case 1.03 - To verify period configuration cli is updated in show running config ###
#### Description ####
...
### Test case 1.04 - To verify OVSDB is updated properly for maxsize configuration ###
#### Description ####
...
### Test case 1.05 - To verify maxsize configuration cli is updated in show running config ###
#### Description ####
...
### Test case 1.06 - To verify logrotate maxsize cli for wrong values ###
#### Description ####
...
### Test case 1.07 - To verify OVSDB is updated properly for 'target' configuration ###
#### Description ####
...
### Test case 1.08 - To verify logrotate target cli for invalid or not supported protocol ###
#### Description ####
...
### Test case 1.09 - To verify logrotate target cli for invalid IPv4 address ###
#### Description ####
...
### Test case 1.10 - To verify logrotate target cli for broadcast IPv4 address ###
#### Description ####
...
### Test case 1.11 - To verify logrotate target cli for multicast IPv4 address ###
#### Description ####
...
### Test case 1.12 - To verify logrotate target cli for loopback IPv4 address ###
#### Description ####
...
### Test case 1.13 - To verify logrotate target cli for invalid IPv6 address ###
#### Description ####
...
### Test case 1.14 - To verify logrotate target cli for multicast IPv6 address ###
#### Description ####
...
### Test case 1.15 - To verify logrotate target cli for loopback IPv6 address ###
#### Description ####
...
##  Test case to verify log-rotation and remote transfer ##

### Objective ###
 Test cases to verify log-rotation in the local host and to verify transfer of rotated logs to remote host.
...
#### Test Setup ####
### Test case 2.01 - To verify log-rotate for period with default configuration  ###
#### Description ####
...
### Test case 2.02 - To verify log-rotate for period with non-default configuration ###
#### Description ####
...
### Test case 2.03 - To verify log-rotate for period with remote host ###
#### Description ####
...
### Test case 2.04 - To verify log-rotate maxsize with default configuration ###
#### Description ####
...
### Test case 2.05 - To verify log-rotate maxsize with non-default configuration ###
#### Description ####
...
### Test case 2.06 - To verify log-rotate maxsize with remote host ###
#### Description ####
...
### Test case 2.07 - To verify log-rotate remote transfer with non-reachable IPv4 address ###
#### Description ####
...
### Test case 2.08 - To verify log-rotate remote transfer with IPv6 address ###
#### Description ####
...
### Test case 2.09 - To verify log-rotate remote transfer with non-reachable IPv6 address ###
#### Description ####
