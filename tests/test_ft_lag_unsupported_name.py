...
#
##########################################################################
# Description: Verify the functionality of creating LAGs with negative or
#              unsupported names to another vlan.
#
# Author:      Oscar Alas Escalante
#
# Topology:                  |DUT|-------|Switch|
#                              |            |
#                              |            |
...
#
#
# Success Criteria:  PASS -> DUT should reject all invalid config
#                            #
