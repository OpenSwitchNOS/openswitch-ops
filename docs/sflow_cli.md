...
sflow sampling <rate>
#### Description
This command sets a sampling rate for sflow.The default sampling rate is 1024.
#### Authority
All users.
#### Parameters
...
#### Description
This command remove a sampling rate for the interface. Sampling rate is set back to default of 1024 globally.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
