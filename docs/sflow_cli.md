...
sflow enable
#### Description
This command enables sflow on the interface.
#### Authority
All users.
#### Parameters
No parameters.
...
no sflow enable
#### Description
This command disables sflow on the interface.
#### Authority
All users.
#### Parameters
No parameters.
...
#### Syntax
sflow sampling <rate> [interface-speed <interface-speed>]
#### Description
This command sets a sampling rate for the interface with the specific interface speed. If interface speed is not specified the sampling rate is applied globally.
#### Authority
All users.
#### Parameters
...
| *interface-speed* | optional | 1G, 10G, 40G, 100G| Checks for interface speed |
#### Examples
```
ops-as5712# configure terminal
ops-as5712(config)# sflow sampling 1024 interface-speed 10G
```
### Remove SFLOW sampling rate
#### Syntax
no sflow sampling <rate> [interface-speed <interface-speed>]
#### Description
This command remove a sampling rate for the interface with the specific interface speed. If interface speed is not specified the sampling rate is applied globally.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
```
ops-as5712# configure terminal
ops-as5712(config)# no sflow sampling 1024 interface-speed 10G
```
...
```
ops-as5712# configure terminal
ops-as5712(config)# no sflow polling 10
```
### Set SFLOW collector ip address
#### Syntax
sflow collector <IP> [port <port>] [vrf <data/management>]
#### Description
This command sets a collector IP (IPv4 or IPv6) adding a port and vrf as an option.
Port defaults to 6343.
VRF is the vrf on which collector can be reached. Default to data vrf.
A maximum of three collectors can be configured.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
#### Description
This command removes an agent-interface if set.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
```
ops-as5712# configure terminal
ops-as5712(config)# no sflow agent-interface 1
```
...
#### Description
This command sets the header size.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
#### Description
This command removes the set header size and sets it back to default.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
```
ops-as5712# configure terminal
ops-as5712(config)# no sflow header-size 64
```
### Set SFLOW max datagram size
#### Syntax
sflow max-datagram-size <size>
#### Description
This command sets the maximum number of bytes that will be send in one sflow datagram.
...
#### Description
This command removes the set number of bytes to be send in one sflow datagram. Resets it to default.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
```
ops-as5712# configure terminal
ops-as5712(config)# no sflow max-datagram-size 1000
```
