...
sflow sampling <rate>
#### Description
This command sets a sampling rate for sflow on all interfaces.The default sampling rate is 1024.
#### Authority
All users.
#### Parameters
...
#### Description
This command remove a sampling rate for sflow on all interfaces. Sampling rate is set back to default of 1024 globally.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
```
ops-as5712# configure terminal
ops-as5712(config)# no sflow sampling 1000
```
