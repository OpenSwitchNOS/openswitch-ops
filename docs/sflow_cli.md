...
sflow sampling <rate>
#### Description
This command sets a global sampling rate for sflow. The default sampling rate is 4096 i.e 1 in 4096 packets will be sampled.
#### Authority
All users.
#### Parameters
...
no sflow sampling
#### Description
This command removes the current sampling rate for sflow and sets it back to default of 4096 globally.A sampling rate of 4056 means 1 in 4096 packets will be sampled.
#### Authority
All users.
#### Parameters
No Parameters.
...
#### Description
This command sets a polling interval. Default polling interval is 30 seconds.If the polling interval is 0 it means polling is disabled.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
...
#### Description
This command removes a polling interval. Default polling interval is 30 seconds.If the polling interval is 0 it means polling is disabled.
#### Authority
All users.
#### Parameters
No Parameters
