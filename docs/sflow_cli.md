...
#### Description
This command sets a sampling rate for the interface with the specific interface speed. If interface speed is not specified the sampling rate is applied globally.The default sampling rate is 1024.
#### Authority
All users.
#### Parameters
...
#### Description
This command remove a sampling rate for the interface with the specific interface speed. If interface speed is not specified the sampling rate is set back to default of 1024 globally.
#### Authority
All users.
#### Parameters
| Parameter | Status   | Syntax         | Description                           |
