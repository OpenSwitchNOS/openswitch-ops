...
#### Examples
The followong configuration example shows that network 10.0.0.0/8 is announced to all neighbors:
...
| Parameter | Status   | Syntax |	Description          |
|-----------|----------|----------------------|
| *A.B.C.D*  | Required | A.B.C.D | The eer IPv4 address. |
...
```
##### Description
This command allows inbound soft reconfiguration of the neighbor.
...
```
##### Description
This command specifies the source address to use for the BGP session to the neighbour.
...
| **no** | Optional | Literal | Remove the match peer local entry. |
