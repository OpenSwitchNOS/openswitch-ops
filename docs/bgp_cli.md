...
#### Description
This command displays all ip prefix list configuration.
...
#### Description
This command displays ip prefix list configuration with specific name and sequence number.
...
#### Description
This command displays detailed ip prefix list configuration with a specific name.
...
#### Description
This command displays summarized ip prefix list configuration with a specific name.
...
#### Description
This command displays all ipv6 prefix list configuration.
...
| Parameter | Status   | Syntax |       Description          |
|-----------|----------|----------------------|
| *WORD*  | Required | String of maximum length 80 characters. | The IPv6 prefix-list name. |
...
#### Description
This command displays ipv6 prefix list configuration with specific name and sequence number.
...
#### Description
This command displays detailed ip prefix list configuration.
...
#### Description
This command displays summarized ipv6 prefix list configuration.
...
#### Description
This command displays summarized ipv6 prefix list configuration with a specific name.
...
#### Description
This command displays ipv6 prefix list configuration with a specific name and ipv6 address.
...
#### Description
This command displays all community list configuration.
...
#### Description
This command display as-path access list configuration with a specific name.
...
| Parameter | Status   | Syntax |       Description          |
|-----------|----------|----------------------|
| *WORD*  | Required | String of maximum length 80 characters. | The as-path-access-list name. |
