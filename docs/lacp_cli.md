...
```
    [no] lacp fallback mode {priority/all_active}
```

##### Description
This command sets LACP fallback mode to **priority** or **all_active**.
The **no** form of the command sets LACP fallback mode to **priority**.

##### Authority
all users

##### Parameters
This command takes a **priority** or **all_active** keyword as an argument to set LACP fallback mode.
...
##### Parameters
This command takes a timeout value in seconds in the range of 1 to 900.
