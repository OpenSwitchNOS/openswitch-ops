...
###  ip ecmp load-balance defaults

##### Syntax
Under the config context.

`ip ecmp load-balance default`

##### Description
Reset ECMP load balancing parameters to platform defaults.
...
##### Example
```
hostname(config)# ip ecmp load-balance default
hostname(config)#
```
