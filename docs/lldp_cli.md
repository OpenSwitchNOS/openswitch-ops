...
| Parameter | Status   | Syntax         | Description                           |
|:-----------|:----------|:----------------:|:---------------------------------------|
| *time* | Required | 1-10 | Select reinit delay between 2 and 10 seconds.
#### Examples
```
ops-as5712# configure terminal
...
`no lldp reinit`
#### Description
This command sets default values for the amount of time to wait before performing LLDP initialization on any interface. The default value is 2 seconds.
#### Authority
All users.
#### Parameters
No parameters.
