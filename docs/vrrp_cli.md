...
`priority <1-254>`
#### Description ####
This command sets the default priority for VRRP group, default value is 100.
#### Authority ####
All users.
#### Examples ####
```
...
`no preempt delay`
#### Description ####
This command sets the default preempt delay for VRRP group, default value is 0 seconds.
#### Authority ####
All users.
#### Examples ####
```
...
`no timers advertise`
#### Description ####
This command sets default advertisement interval in milliseconds, default value is 1000.
#### Authority ####
All users.
#### Examples ####
```
