...
- Ref-id for the NTPv6 server will always be compressed from IPv6 to IPv4 address.
...
For infomation on RFC for NTPv6 refid format, see
https://tools.ietf.org/html/draft-boudreault-ipv6-ntp-refid-00
