...
ops_debug: false
```
Create task file to configure OpenSwitch and debug Ansible transaction as <b>tasks/main.yml</b>
```
---
...
```
Refer to <b>schema/vswitch/ovsschema</b> in ops repository, we noticed the main table for ops is named <i>System</i>, and it have column <i>bridges</i> that we need
```
...
  "tables": {
    "System": {
  ...
  ...
```
So we create first template to iterate through System table as <b>templates/ops_system.j2</b>
```
...
```
Based on this fact, we crate template to iterate through <i>bridges</i> column as <b>templates/ops_system_bridges.j2</b>
```
