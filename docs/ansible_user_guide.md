...
With basic Ansible knowledge from previous sections. Now we are ready to create our first Ansible role for OpenSwitch. This instruction will demonstrate how to create an Ansible role for OpenSwitch BGP module configuration and testing.

### Create and initialize VLAN role
To begin with, we will first initialize bgp role under <b>/etc/ansible/roles</b> folder with ansible-galaxy API
```
ansible-galaxy init bgp
```
Create default file for the bgp role as <b>defaults/main.yml</b>
```
---
# defaults/main.yml
