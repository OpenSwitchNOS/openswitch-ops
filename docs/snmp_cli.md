...
|Table|Column|key|
|--------|----------|--------|
|System|other_config|snmp_agent_port|
...
|Table|Column|key|
|--------|----------|--------|
|SNMPv3_User|user_name|NA|
|SNMPv3_User|auth_protocol|NA|
|SNMPv3_User|auth_pass_phrase|NA|
|SNMPv3_User|priv_protocol|NA|
|SNMPv3_User|priv_pass_phrase|NA|
...
|Table|Column|key|
|--------|----------|--------|
|SNMP_Trap|receiver_address|NA|
|SNMP_Trap|type|NA|
|SNMP_Trap|version|NA|
|SNMP_Trap|community_name|NA|
|SNMP_Trap|receiver_udp_port|NA|
...
|Table|Column|key|
|--------|----------|--------|
|System|other_config|system_contact|
|System|other_config|system_description|
|System|other_config|system_location|
