...
## Related features  ##
When configuring the switch for LACP, it might also be necessary to configure the Physical Interface. [Physical Interface](/tbd/other_filefeatures/related_feature1.html#first_anchor) .
