...
#### Authority
Users in group ops_netop may execute this command.
#### Parameters
No parameters.
#### Examples
```
...
#### Authority
Only users in  group ops_netop may execute this command
#### Parameters
...
`no banner`
#### Description
This command replaces the pre-login banner string with an empty string, functionally disabling the banner.
#### Authority
Only users in group ops_netop may execute this command.
#### Parameters
No parameters.
...
`no banner exec`
#### Description
This command replaces the post-login banner string with an empty string, functionally disabling the banner.
#### Authority
Only users in group ops_netop may execute this command.
#### Parameters
No parameters.
