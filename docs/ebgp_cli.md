...
| **no** | Optional | Literal | Destroys a eBGP router with the specified AS number. |
...
#### Description
This command specifies the eBGP router-ID for a eBGP router.
...
#### Description
This command sets the maximum number of paths for a eBGP router.
...
#### Description
This command sets the keepalive interval and hold time for a eBGP router.
...
##### Description
This command matches a eBGP autonomous system path access list.
...
##### Description
This command matches a eBGP community. Use this command in route-map configuration mode.
...
##### Description
This command matches a eBGP community with an exact match of communities.
...
##### Description
This command sets the target extended community (in decimal notation) of a eBGP route. The COMMUNITY attribute value has the syntax AA:NN, where AA represents an AS or IP address, and NN is the community identifier.
...
##### Description
This command sets the site-of-origin extended community (in decimal notation) of a eBGP route. The COMMUNITY attribute value has the syntax AA:NN, where AA represents an AS or IP address, and NN is the community identifier.
...
##### Description
This command sets the weight of a eBGP route. A route`s weight has the most influence when two identical eBGP routes are compared. A higher number signifies a greater preference.
...
## CLI
 
Click [here](http://www.openswitch.net/documents/user/ebgp_cli) for CLI commands related to the eBGP feature.
