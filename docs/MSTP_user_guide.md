...
|{config_parameter} should be {value}                                  |Fwd delay should be >= 10|
...
|{proto} - Topology Change generated on port {port} going in to {state}|Topology Change generated on port 1 going in to forwarding|
