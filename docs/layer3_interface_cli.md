...
#### Description
Displays L3 and IPv4 specific information for the interfaces including statistics, configuration and interface state. Currently this command is only supported for L3 physical interfaces and does not support other L3 vlan interfaces.
...
#### Description
Displays L3 and IPv6 specific information for the interfaces including statistics, configuration and interface state. Currently this command is only supported for L3 physical interfaces and does not support other L3 vlan interfaces.
