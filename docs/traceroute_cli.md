...
|-----------|---------|--------|-------------|
|*IPv4-address*|Required| A.B.C.D | IPv4 address to traceroute. The parameter should be IPv4-address.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
|*hostname* |Required | string | Hostname to traceroute. Length must be less than 256 characters. The parameter should be string.|
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *maxttl*  |Optional |<1-255> | Select maximum number of hops used in outgoing probe packets between 1 to 255. The parameter should be number.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *minttl*  |Optional |<1-255> | Select minimum number of hops used in outgoing probe packets between 1 to 255. The parameter should be number.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *dstport* |Optional |<1-34000>| Select the destination port number. The parameter should be number.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *probes*  | Optional| <1-5>  | Select the number of probe queries to send out for each hop between 1 to 5. The parameter should be number.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *timeout* | Optional|<1-120> | Select time in seconds to wait for a response to a probe between 1 and 120. The parameter should be time.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
|*ip-option*|Optional | A.B.C.D | loose source route address to traceroute. The parameter should be IPv4-address.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
|*IPv6-address*|Required|X:X::X:X| IPv6 address to traceroute. The parameter should be IPv6-address.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *hostname*|Required | string | Hostname to traceroute. Length must be less than 256 characters. The parameter should be number.|
#### Examples
```
