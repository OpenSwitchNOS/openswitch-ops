...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *maxttl*  |Optional |<1-255> | Select maximum number of hops used in outgoing probe packets between 1 to 255.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *minttl*  |Optional |<1-255> | Select minimum number of hops used in outgoing probe packets between 1 to 255.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *dstport* |Optional |<1-34000>| Select the destination port number.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *probes*  | Optional| <1-5>  | Select the number of probe queries to send out for each hop between 1 to 5.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
| *timeout* | Optional|<1-120> | Select time in seconds to wait for a response to a probe between 1 and 120.|
#### Examples
```
...
| Parameter | Status  | Syntax | Description |
|-----------|---------|--------|-------------|
|*ip-option*|Optional | A.B.C.D | loose source route address to traceroute.|
#### Examples
```
