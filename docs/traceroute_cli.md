...
| Parameter | Syntax | Description|
|-----------|---------|-------------|
| *probes* | <1-5> | Select the number of probe queries to send out for each hop between 1 to 5.|
#### Examples
```
...
#### Examples
```
switch# traceroute 10.168.1.146 ip-option loosesourceroute10.57.191.129
traceroute to 10.168.1.146 (10.168.1.146) , 30 hops max
1 10.57.191.129 2 ms 3 ms 3 ms
2 10.57.232.1 4 ms 2 ms 3 ms
3 10.168.1.146 4 ms 3 ms 3 ms
...
| Parameter | Syntax | Description|
|-----------|---------|-------------|
| *IPv6-address* | X:X::X:X | IPv6 address to traceroute.|
#### Examples
```
