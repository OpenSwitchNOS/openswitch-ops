...
show 
#### Description ####
Display current non default configuration on the switch. We don't display any user information as user configuration is an exec command and not saved in OVSDB.  
#### Authority ####
All users
#### Parameters ####
N/A
