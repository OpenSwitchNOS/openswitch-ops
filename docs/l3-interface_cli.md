...
##### Description
Attach/dettach an interface from a VRF.
...
##### Description
Configures an IP address to the specified port.
...
##### Example
Configures an IPv4 on the interface.
```
...
##### Description
Configures an IPv6 address to the specified port.
...
##### Example
Configures an IPv6 on the interface.
```
hostname(config)# interface 1
