...
- [Ping Options](##ping-options)
	...
	- [Hostname](#hostname)
	- [Set Data-fill pattern](#set-data-fill-pattern)
	- [Set Datagram-size](#set-datagram-size)
	- [Set Interval](#set-interval)
    - [Set Repetitions](#set-repetitions)
	- [Set Timeout](#set-timeout)
    - [Set TOS](#set-tos)
	- [Set Ip-option](#set-ip-option)
...
| *IPv4-address* | A.B.C.D | IPv4 address to ping.
#### Examples
```
...
#### Parameters
| Parameter | Syntax | Description
| *hostname* | string | Hostname to ping. Length must be less than 256 characters.
#### Examples
```
...
#### Parameters
| Parameter | Syntax | Description
| *data-fill* | string | Set Hexadecimal pattern to be filled in the packet.
#### Examples
```
...
#### Parameters
| Parameter | Syntax | Description
| *datagram-size* | <100-65468> | Select datagram-size between 100 and 65468.
#### Examples
```
...
#### Parameters
| Parameter | Syntax | Description
| *interval* | <1-60> | Select interval in seconds between 1 and 60.
#### Examples
```
...
#### Parameters
| Parameter | Syntax | Description
| *repetitions* | <1-10000> | Select the number of packets to send between 1 and 10000.
#### Examples
```
...
#### Parameters
| Parameter | Syntax | Description
| *timeout* | <1-60> | Select timeout in seconds between 1 and 60.
#### Examples
```
...
#### Description
This command sets Type of Service -related bits in ICMP datagrams.
#### Authority
Root user.
#### Parameters
| Parameter | Syntax | Description
| *tos* | <0-255> | Select the tos value between 0 and 255.
#### Examples
```
...
#### Description
This command is used to Record the intermediate router timestamp or Record the intermediate router timestamp and IP address or Record the intermediate router addresses.
#### Authority
Root user.
#### Parameters
No parameters.
...
#### Parameters
| Parameter | Syntax | Description
| *IPv6-address* | X:X::X:X | IPv6 address to ping.
#### Examples
```
switch# ping6 2000::1
