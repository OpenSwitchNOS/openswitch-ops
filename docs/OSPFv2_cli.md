...
#### Description ####
This command set the cost of default-summary LSAs announced to NSSA or stub areas.
#### Authority ####
All users.
#### Parameters ####
Choose one of the following parameters to identify the area.
...
| Parameter | Status   | Syntax         | Description                           |
|:-----------|:----------|:----------------:|:---------------------------------------|
| **default-cost** | Required | Literal | Set the cost of default-summary LSAs announced to NSSA or stub areas. |
...
#### Description ####
This command reset the cost of default-summary LSAs announced to NSSA or stub areas to default. The default value is 1.
#### Authority ####
All users.
#### Parameters ####
Choose one of the following parameters to identify the area.
...
| Parameter | Status   | Syntax         | Description                           |
|:-----------|:----------|:----------------:|:---------------------------------------|
| **default-cost** | Required | Literal | Set the cost of default-summary LSAs announced to NSSA or stub areas to default. |
