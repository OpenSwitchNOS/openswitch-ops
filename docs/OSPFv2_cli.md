...
`ospf enable`
#### Description ####
This command enables OSPF feature globally.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
`no ospf enable`
#### Description ####
This command disables OSPF feature globally.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
### Enable OSPF for the OSPF instance
#### Syntax ####
`enable`
#### Description ####
This command enables OSPF feature for the OSPF instance.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
```
### Disable OSPF for the OSPF instance
#### Syntax ####
`no enable`
#### Description ####
This command disables OSPF feature for the OSPF instance. This command doesn't delete any configurations.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
switch# configure terminal
switch# router ospf
switch(config-router)# no enable
```
### Set router ID
#### Syntax ####
...
#### Syntax ####
`ip router ospf area (<area_ip> | <area_id>)`
#### Description ####
This command enables OSPF on a particular interface and add it to an area.
#### Authority ####
All users.
#### Parameters ####
Choose one of the following parameters to identify the area.
...
switch# configure terminal
switch# interface 1
switch(config-if)# ip router ospf area 0.0.0.1
```
### Disable OSPF on the interface
#### Syntax ####
`no ip router ospf area (<area_ip> | <area_id>)`
#### Description ####
This command disables OSPF on a particular interface and remove it from an area if it is a part of it.
#### Authority ####
All users.
#### Parameters ####
Choose one of the following parameters to identify the area.
...
switch# configure terminal
switch# interface 1
switch(config-if)# no ip router ospf area 0.0.0.1
```
...
#### Description ####
This command configures the interface as passive interface. With this setting the interface will receive routing updates but won't send any routing updates and thereby appear as dead to the neighbor routers connected to this interface.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
#### Description ####
This command configures the interface as active interface. With this setting the interface will send any routing updates to the neighbor routers connected to this interface.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
switch# configure terminal
switch# interface 1
switch(config-if)# no ip ospf passive-interface
```
...
```
### Specify neighbor router of the interface
#### Syntax ####
`neighbor <neighbor_ip> {poll-interval <poll_value> | priority <priority_value>}`
#### Description ####
This command specifies a neighbor of the interface and, also sets priority and polling interval (in seconds) for that neighbor.
#### Authority ####
All users.
#### Parameters ####
| Parameter | Status   | Syntax         | Description |
...
switch# configure terminal
switch# interface 1
switch(config-if)# neighbor 16.77.114.14
switch(config-if)# neighbor 16.77.114.14 poll-interval 40
switch(config-if)# neighbor 16.77.114.14 priority 20
switch(config-if)# neighbor 16.77.114.14 priority 20 poll-interval 40
```
### Remove neighbor router of the interface
#### Syntax ####
`no neighbor <neighbor_ip> {poll-interval | priority}`
#### Description ####
This command removes a neighbor of the interface and/or, also sets priority and polling interval (in seconds) for that neighbor, to default.The `no neighbor <neighbor_ip>` command removes the neighbor completely.
#### Authority ####
All users.
#### Parameters ####
| Parameter | Status   | Syntax         | Description |
...
switch# configure terminal
switch# interface 1
switch(config-if)# no neighbor 16.77.114.14
switch(config-if)# no neighbor 16.77.114.14 poll-interval
switch(config-if)# no neighbor 16.77.114.14 priority
```
