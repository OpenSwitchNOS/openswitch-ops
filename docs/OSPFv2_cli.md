...
#### Description ####
This command sets the rate limit values for OSPF SPF calculation to default.
#### Authority ####
All users.
#### Parameters ####
| Parameter | Syntax | Description |
...
`ip ospf mtu-ignore`
#### Description ####
This command disables the MTU mismatch detection on the interface. When the MTU value in the database description packet coming from a neighbor is larger than the router can handle then the packet may be dropped without this setting.
#### Authority ####
All users.
#### Parameters ####
No parameters.
...
#### Description ####
This command enables the MTU mismatch detection on the interface. When the MTU value in the database description packet coming from a neighbor is larger than the router can handle, the packet may be dropped with this setting.
#### Authority ####
All users.
#### Parameters ####
No parameters.
