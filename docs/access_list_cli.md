...
| *direction* | Required | Keyword | Apply to inbound (ingress) or outbound (egress) traffic. |

#### Examples

Apply *My_ACL* on interfaces 1 and 2 ingress
...
Apply *My_ACL* on VLANs 1 and 2 ingress
...
| **direction** | Optional | String  | Limit display to ingress or egress ACLs. |
...
| **id**        | Optional | String  | The name or ID of the interface or VLAN. |
| **direction** | Optional | Keyword | Operate on ACLs applied to ingress or egress traffic. |
