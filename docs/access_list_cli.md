...
| *permit*          | Required | Keyword                    | Permit traffic matching this ACE. |
| *deny*            | Required | Keyword                    | Deny traffic matching this ACE. |
| *comment*         | Required | Keyword                    | Store the remaining entered text as a comment ACE. |
...
| *count*           | Optional | Keyword                    | Keep a count of the number of packets matching this ACE. |
...
| *acl-name*  | Required | String  | Operate on a specific ACL. |
| *interface* | Required | Keyword | Specify the interface the ACL is applied to. |
| *vlan*      | Required | Keyword | Specify the VLAN the ACL is applied to. |
