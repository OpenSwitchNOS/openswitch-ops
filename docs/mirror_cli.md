...
#### Description
The **source interface** command assigns the specified Ethernet interface or LAG
and direction where mirror traffic for this session be sourced.  The parameter
specifies which direction of traffic is mirrored on the source port:
...
#### Description
Without a 'NAME' parameter, this command will display the list of mirror
sessions and their status.

With a 'NAME' parameter, this command will display the details of that mirror
session.
