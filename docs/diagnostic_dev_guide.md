...
Define a callback function that collects the necessary diagnostics information from the daemon for the given feature. This callback function needs to fill a buffer to  hold the diagnostics information. The callback function should return this buffer.
