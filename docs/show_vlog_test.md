...
### Test result criteria
#### Test pass criteria
'show vlog config' command displays the features corresponding daemons log levels of file and syslog destinations on the console.
#### Test fail criteria
...
### Test result criteria
#### Test pass criteria
User cant see configuration changes on configuration node .using `show vlog config feature <feature_name>` to obtain configuration changes on Enable mode.
#### Test fail criteria
