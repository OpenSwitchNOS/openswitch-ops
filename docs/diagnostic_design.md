...
1. Define the callback function for the basic diagnostic information collection.
...
function contains the feature name in the argument `argv`. The callback handler collects all
the diagnostic information and copies it to a buffer and returns the buffer.
