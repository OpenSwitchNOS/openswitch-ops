...
### Requirements
Ensure that feature related daemon are not running on switch . Feature related daemon are available in ops_diagdump.yaml file.
### Setup
#### Topology diagram
```ditaa
+---------+
...
### Requirements
EnsDelete the config ops_diagdump.yaml file.
### Setup
#### Topology diagram
```ditaa
+---------+
...
### Requirements
Remove all conent of the config ops_diagdump.yaml file.
### Setup
#### Topology diagram
```ditaa
+---------+
