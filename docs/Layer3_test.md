...
### Description
1. Assign IP and IPv6 address to an interface on the switch.
...
![Toplogy](images/ipv4-static-routes.png)
...
![Toplogy](images/ipv6-static-routes.png)
...
* If the routes gets added again, ping passes, implying that the routes get correctly deleted from the kernel and the database.
#### Test Fail Criteria
