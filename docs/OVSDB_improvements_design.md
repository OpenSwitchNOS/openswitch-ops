...
The `<wait-updates>` object contains the contents of the currently outstanding
waits for which “result” is an empty object.
...
The `<json-value>` in params is a JSON object with the information required by
