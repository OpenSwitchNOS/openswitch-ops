...
|:-----------|:----------------:|:---------------------------------------|
| *range-name*   | length < 15 | Set DHCP dynamic configuration name
...
| *match_tag_names* | each tag length <15 | Set the match tags list.
| *set_tag_name* | length <15 | Set the set tag name.
...
| Parameter | Syntax | Description                                |
|:-----------|:----------------:|:---------------------------------------|
| *range-name*   | length < 15 | Specify DHCP dynamic configuration name
...
| *match_tag_names* | each tag length <15 | Specify the match tags list.
| *set_tag_name* | length <15 | Specify the set tag name.
...
| *hostname* | length < 15 | Set the client hostname.
| *client-id* | length <15 | Set the client id.
| *set_tag_name* | each tag length <15 | Set the set tags list.
| *lease-duration* | value in minutes | Set the lease duration value.
#### Example ###
```
ops-as5712# configure terminal
...
| *hostname* | length < 15 | Specify the client hostname.
| *client-id* | length <15 | Specify the client id.
| *set_tag_name* | each tag length <15 | Specify the set tags list.
| *lease-duration* | value in minutes | Specify the lease duration value.
#### Example ###
```
ops-as5712# configure terminal
...
| Parameter | Syntax | Description                                |
|:-----------|:----------------:|:---------------------------------------|
| *option_name* | length<15 | Set DHCP option name.
...
|:-----------|:----------------:|:---------------------------------------|
| *set_tag_name* | length<15 | Set the set tag name.
| *option_number* | length<15 | Set DHCP option number.
| *option_value* | | Set DHCP option value.
#### Example ###
```
ops-as5712# configure terminal
...
| *match_tag_name* | length <15 | Set match tag name.
#### Example ###
```
ops-as5712# configure terminal
ops-as5712(config)# dhcp-server
...
----------------------------------------
Name              Start IP Address                              End IP Address                                Netmask          Broadcast        Prefix-len  Lease time(min)  Static  Set tag          Match tags
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
dynamic           10.0.0.1                                      10.255.255.254                                255.0.0.0        10.255.255.255   *           60               False   tag4             tag1,tag2,tag3
