...
===============================================================================================
Name      ref-id  VER  remote    stratum  type  last  poll  reach  delay  offset  jitter
===============================================================================================
192.0.1.1 .INIT.  4              2        U     10    64    0      0.121  0.000   0.000
```

#### Key
```
name    : NTP server FQDN/IPV4 address
ref-id  : Reference ID for the remote server (Can be an IP address)
