...
'''
    ...
    header_str +=\
        '\n#ifndef OPS_EMPTY_VALUES_HEADER' +\
        '\n#define OPS_EMPTY_VALUES_HEADER'
    ...
    header_str += dump_string(LT_COMMENT, warning_str)
    return header_str


def generate_footer_text():
    return "\n\n#endif /* OPS_EMPTY_VALUES_HEADER */"
