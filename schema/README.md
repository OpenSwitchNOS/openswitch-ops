...
Even the final implementation is not fully compliant with the content started
in the thread, it is an interesting point to understand the background on the
